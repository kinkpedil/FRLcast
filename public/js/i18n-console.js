...
(function () {
  ...
  var ID = {
    ...
    'fastest-lap banner, battles, Results scene': 'banner lap tercepat, duel, scene Hasil',
    'In a race it also puts the head-to-head on air when two cars stay within a second of each other for a few seconds, and takes it down once the fight is over (never one you turned on yourself).':
      'Saat race, director juga menayangkan head-to-head ketika dua mobil bertahan dalam jarak satu detik selama beberapa detik, lalu menurunkannya setelah duel selesai (tidak pernah yang kamu nyalakan sendiri).',
    'Battle on air': 'Duel tayang',
    "Post each session's result at the chequered flag": 'Kirim hasil tiap sesi saat bendera finish',
    'Post the standings when a round is scored': 'Kirim klasemen saat satu ronde dicatat',
    'Qualifying and practice post a best-lap table with gaps to pole; a race posts positions, gaps, the fastest lap and penalties. A session the timing API ran is often never flagged finished: post it with the button.':
      'Qualy dan practice mengirim tabel best lap dengan gap ke pole; race mengirim posisi, gap, lap tercepat, dan penalti. Sesi yang dijalankan timing API sering tidak diakhiri bendera finish: kirim lewat tombol.',
    'Post result now': 'Kirim hasil sekarang',
    'Post standings now': 'Kirim klasemen sekarang',
    'no time': 'tanpa waktu',
    'penalties': 'penalti',
    'Race result': 'Hasil race',
    'Endurance result': 'Hasil endurance',
    'Qualifying result': 'Hasil kualifikasi',
    'Practice result': 'Hasil latihan',
    'Drift result': 'Hasil drift',
    'pts': 'poin',
    'standings': 'klasemen',
    'No rounds scored yet.': 'Belum ada ronde yang dicatat.',
    'After': 'Setelah',
    'round': 'ronde',
    'rounds': 'ronde',
    'Knockout qualifying': 'Kualifikasi knockout',
    'Q1, Q2, Q3 (optional)': 'Q1, Q2, Q3 (opsional)',
    'Cars through to Q2': 'Mobil yang lolos ke Q2',
    'Cars through to Q3': 'Mobil yang lolos ke Q3',
    'Restart from Q1': 'Ulang dari Q1',
    'Run each part like a session: Start, then End. Cars below the red line when a part ends are knocked out and keep their place and time; the rest start the next part from zero. After Q3 the order is final: use Grid from current order to set the race grid.':
      'Jalankan tiap babak seperti satu sesi: Mulai, lalu Akhiri. Mobil di bawah garis merah saat babak berakhir tersingkir dan tetap memegang posisi serta waktunya; sisanya memulai babak berikutnya dari nol. Setelah Q3 urutannya final: pakai Grid dari urutan sekarang untuk grid race.',
    'Restart the knockout from Q1? Knocked-out cars come back.': 'Ulang knockout dari Q1? Mobil yang tersingkir kembali ikut.',
    'End Q3? The order becomes the final qualifying result.': 'Akhiri Q3? Urutannya menjadi hasil kualifikasi final.',
    'End': 'Akhiri',
    'start': 'mulai',
    'Cars below the red line are knocked out.': 'Mobil di bawah garis merah tersingkir.',
    'FINAL': 'FINAL',
    'End Q3, final result': 'Akhiri Q3, hasil final',
    'Incident reports': 'Laporan insiden',
    'none open': 'tidak ada yang terbuka',
    'open': 'terbuka',
    'New incident report': 'Laporan insiden baru',
    'about': 'tentang',
    'lap': 'lap',
    'Investigate': 'Selidiki',
    'Mark reviewed': 'Tandai sudah ditinjau',
    'Dismiss': 'Abaikan',
    'Reopen': 'Buka lagi',
    'reviewed': 'sudah ditinjau',
    'dismissed': 'diabaikan',
    'No reports.': 'Tidak ada laporan.',
    'No car with that number on the grid': 'Tidak ada mobil dengan nomor itu di grid',
    'Investigation opened in Race control': 'Investigasi dibuka di Race control',
    'checked in': 'sudah check-in',
    "Drivers report an incident from the driver app. A report is not a decision: Investigate opens an investigation on the reported car (with the penalty type and seconds chosen in Race control below), then you decide it there. The driver's own words stay here and never go on air.":
      'Pembalap melaporkan insiden dari aplikasi driver. Laporan bukan keputusan: Selidiki membuka investigasi pada mobil yang dilaporkan (dengan jenis penalti dan detik yang dipilih di Race control di bawah), lalu kamu memutuskannya di sana. Kata-kata pembalap tetap di sini dan tidak pernah tayang.',
